        ...
        * { box-sizing: border-box; }
        ...
        <table style="margin-bottom:8px;">
          ...
          <tr>
            ...
            <td>${(userMeta.first_name || user?.first_name || 'N/A')} ${(userMeta.last_name || user?.last_name || '')}, ${(userMeta.company_name || 'N/A')}, ИНН ${(userMeta.vat_number || 'N/A')}, ${(orderData?.shippingAddress || orderData?.address || userMeta.address || userMeta.city || 'г. Москва, ул. Примерная, д. 123')}</td>
                 </tr>
             </table>
